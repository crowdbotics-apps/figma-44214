"""
Django settings for figma_44214 project.
...
WSGI_APPLICATION = 'figma_44214.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "figma_44214 API",
    "DESCRIPTION": "API documentation for figma_44214 App",
    "VERSION": "v1",
}
